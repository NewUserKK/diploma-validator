...
public class StructuralElementCaseError extends StructuralElementStyleError {

    public StructuralElementCaseError(StructuralElement element, String description, Location location) {
